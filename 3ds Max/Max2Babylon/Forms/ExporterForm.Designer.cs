namespace Max2Babylon
{
    partial class ExporterForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.chkManifest.Text = "生成 .manifest";
			...
			this.chkWriteTextures.Text = "写入纹理";
			...
			this.chkExportAnimationsOnly.Text = "仅导出动画";
			...
			this.chkExportAnimations.Text = "导出动画";
			...
			this.lblBakeAnimation.Text = "烘焙动画选项:";
			// 
			...
			this.chkApplyPreprocessToScene.Text = "应用预处理到场景";
			...
			this.chkMrgContainersAndXref.Text = "合并容器与外部参照";
			...
			this.chkUsePreExportProces.Text = "使用预导出处理:";
			...
			this.label7.Text = "Babylon PBR 选项:";
			// 
			// txtEnvironmentName
			// 
			...
			this.chkNoAutoLight.Text = "不自动添加灯光";
			...
			this.chkExportMaterials.Text = "导出材质";
			...
			this.chkKHRMaterialsUnlit.Text = "KHR_materials_unlit (无光照材质)";
			...
			this.chkKHRTextureTransform.Text = "KHR_texture_transform (纹理变换)";
			...
			this.chkKHRLightsPunctual.Text = "KHR_lights_punctual (点光源)";
			...
			this.chkOverwriteTextures.Text = "覆盖纹理";
			...
			this.chkDoNotOptimizeAnimations.Text = "不优化动画";
			...
			this.chkAnimgroupExportNonAnimated.Text = "(动画组) 导出非动画对象";
			...
			this.chkDracoCompression.Text = "使用 Draco 压缩";
			...
			this.chkExportMorphNormals.Text = "导出变形法线";
			...
			this.chkExportMorphTangents.Text = "导出变形切线";
			...
			this.chkExportTangents.Text = "导出切线";
			...
			this.chkOnlySelected.Text = "仅导出选中对象";
			...
			this.chkAutoSave.Text = "保存 3ds Max 文件";
			...
			this.butExportAndRun.Text = "导出并运行";
			...
			this.butMultiExport.Text = "多文件导出 | Shift+点击编辑";
			...
			this.envFileDialog.Filter = "DDS 文件|*.dds";
			this.envFileDialog.Title = "选择环境贴图";
			// 
			// butCopyToClipboard
			// 
			...
			this.butCopyToClipboard.Text = "复制到剪贴板";
			...
			this.exportOptionsTabPage.Text = "选项";
			...
			this.chkExportMorphNames.Text = "导出变形名称";
			...
			this.chkUseClone.Text = "使用克隆 (实验性)";
			...
			this.chkTryReuseTexture.Text = "尝试复用纹理";
			...
			this.dracoGroupBox.Text = "Draco 设置";
			// 
			// dracoUserControl
			// 
			...
			this.Text = "Babylon.js - 导出场景到 babylon 或 glTF 格式";

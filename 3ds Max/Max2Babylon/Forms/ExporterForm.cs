...
namespace Max2Babylon
{
    public partial class ExporterForm : Form
    {
        ...
        public ExporterForm(BabylonExportActionItem babylonExportAction)
        {
            ...
            this.Text = $"Babylon.js - 导出场景到 babylon 或 glTF 格式 v{BabylonExporter.exporterVersion}";
        ...
        private void ExporterForm_Load(object sender, EventArgs e)
        {
            ...
            {
                CreateErrorMessage("必须将 3dsMax 2020 更新至 2020.2 版本才能使用 Max2Babylon。未修补的版本在导出时会崩溃。", 0);
            }
            else
            {
                CreateMessage(String.Format("使用 Max2Babylon (适用于 3dsMax 版本 v{0}.{1}.{2}.{3}", maxVersion.Major, maxVersion.Minor, maxVersion.Revision, maxVersion.BuildNumber), Color.Black, 0, true);
            }
        }
        ...
        private void butModelBrowse_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog.ShowDialog(this) == DialogResult.OK)
            {
                ...
                {
                    CreateWarningMessage("警告: 纹理路径应位于模型文件路径之下，部分客户端渲染器不支持此功能", 0);
                }
            }
        }
        ...
        private async Task<bool> DoExport(ExportItem exportItem, bool multiExport = false, bool clearLogs = true)
        {
            ...
            try
            {
                ...
                {
                    throw new InvalidDataException(String.Format("无效的缩放因子值: {0}", txtScaleFactor.Text));
                }
                try
                {
                ...
                {
                    throw new InvalidDataException(String.Format("无效的纹理质量值: {0}", txtScaleFactor.Text));
                }
            ...
            catch (Exception ex)
            {
                ...
                currentNode = CreateTreeNode(0, "导出已取消: " + ex.Message, Color.Red);
        ...
        private void comboOutputFormat_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (outputFormat)
            {
                ...
                case "binary babylon":
                    ...
                    this.saveFileDialog.Filter = "Babylon 文件|*.babylon";
                    chkDracoCompression.Checked = false;
                    chkDracoCompression.Enabled = false;
                ...
                case "gltf":
                    ...
                    this.saveFileDialog.Filter = "glTF 文件|*.gltf";
                ...
                case "glb":
                    ...
                    this.saveFileDialog.Filter = "glb 文件|*.glb";
                    chkDracoCompression.Enabled = gltfPipelineInstalled;
        ...
        private void exportOptionsScrollPanel_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (ctrl != null)
            {
                ...
                {
                    string tip = "仅适用于 glTF 和 glb 导出。\n需要安装 Node.js 和 gltf-pipeline 模块。";

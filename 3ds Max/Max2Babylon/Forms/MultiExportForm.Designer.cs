namespace Max2Babylon
{
    partial class MultiExportForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btn_change_path.Text = "更改所选项目路径";
            ...
            this.ColumnKeepPositionCheckbox.HeaderText = "保持位置";
            ...
            this.ColumnLayers.HeaderText = "图层";
            ...
            this.ColumnNode.HeaderText = "根节点";
            ...
            this.ColumnFilePath.HeaderText = "文件路径";
            ...
            this.ColumnTexturesFolder.HeaderText = "纹理文件夹";
